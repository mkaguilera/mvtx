...
AVLTreeLock *AVLTreeLock::createLock() {
  AVLTreeLock *root = new AVLTreeLock();
  AVLTreeLock *new_lock = new AVLTreeLock(root);
...
void AVLTreeLock::insert(AVLTreeLock *new_lock) {
...
void AVLTreeLock::remove(AVLTreeLock *lock) {
  if (lock->_left != nullptr) {
    AVLTreeLock *new_lock = lock->_left;
    AVLTreeLock *parent;
...
void AVLTreeLock::swap(AVLTreeLock *parent, AVLTreeLock *child, bool is_left) {
...
void AVLTreeLock::updateHeight() {
  ...
  _left_height = _left == nullptr ? 0 : (_left->_left_height >= _left->_right_height ? _left->_left_height+1
                                                                                     : _left->_right_height+1);
  _right_height = _right == nullptr ? 0 : (_right->_left_height >= _right->_right_height ? _right->_left_height+1
                                                                                         : _right->_right_height+1);
